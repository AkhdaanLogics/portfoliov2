...
date: "2021-03-16"
repository: akhdaan/terraform-provider-vercel
url: https://registry.terraform.io/providers/akhdaan/vercel/latest
published: "true"
---
...
terraform {
  required_providers {
    vercel = {
      source  = "registry.terraform.io/akhdaan/vercel"
      version = ">=0.10.3"
    }
  }
}
...
resource "vercel_project" "my_project" {
  ...
  git_repository {
    type = "github"
    repo = "akhdaan/terraform-provider-vercel"
  }
}
```
...
Now that Vercel have stepped in, I have decided to [deprecate](https://twitter.com/akhdaan_/status/1517759708983177218) this one on April 23rd 2022.
